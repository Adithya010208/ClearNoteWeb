      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
        ...
        >
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 bg-slate-900 text-white py-4 rounded-2xl font-bold text-lg hover:bg-slate-800 focus:ring-4 focus:ring-slate-200 outline-none transition-all active:scale-95 shadow-xl shadow-slate-200 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isSigningIn ? (
